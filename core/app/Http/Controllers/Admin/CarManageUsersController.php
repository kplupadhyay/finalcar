...
use App\Models\CarPaymentLog;
use App\Models\CarUser;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class CarManageUsersController extends Controller
{
    ...
    public function deletedUsers()
    {
        ...
        $users = CarUser::onlyTrashed()->searchable(['username', 'email'])->orderBy('id', 'desc')->paginate(getPaginate());
    ...
    {
        CarUser::onlyTrashed()->where('id', $id)->restore();
    ...
    {
        $user                        = CarUser::withTrashed()->findOrFail($id);
        $pageTitle                   = 'Details of ' . $user->username;
        $widget['total_bookings']    = CarBooking::where('user_id', $id)->count();
        $widget['running_bookings']  = CarBooking::active()->where('user_id', $id)->count();
        $widget['booking_requests']  = CarBookingRequest::initial()->where('user_id', $id)->count();

        $widget['total_payment']     = CarPaymentLog::where('type', 'BOOKING_PAYMENT_RECEIVED')->whereHas('booking', function ($booking) use ($id) {
    ...
    public function showNotificationAllForm()
    {
        ...
        $notifyToUser = CarUser::notifyToUser();
        $users = CarUser::withTrashed()->active()->count();
    ...
    public function sendNotificationAll(Request $request)
    {
        ...
        $users = CarUser::oldest()->withTrashed()->active()->$scope()->skip($request->start)->limit($request->batch)->get();
    ...
    public function notificationLog($id)
    {
        ...
        $logs      = CarNotificationLog::where('user_id', $id)->with('user')->orderBy('id', 'desc')->paginate(getPaginate());
