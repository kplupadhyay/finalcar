                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.carlocation.cit.all')); ?>?search=<?php echo e($country->name); ?>"><span class="badge badge--primary"><?php echo e($country->total_city); ?></span></a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button-group">
                                                ...
                                                <?php if($country->status == Status::DISABLE): ?>
                                                    <button class="btn btn-sm btn-outline--success me-1 confirmationBtn" data-action="<?php echo e(route('admin.carlocation.countr.status.update', $country->id)); ?>" data-question="<?php echo app('translator')->get('Are you sure to enable this facility?'); ?>" type="button">
                                                        <i class="la la-eye"></i> <?php echo app('translator')->get('Enable'); ?>
                                                    </button>
                                                <?php else: ?>
                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn" data-action="<?php echo e(route('admin.carlocation.countr.status.update', $country->id)); ?>" data-question="<?php echo app('translator')->get('Are you sure to disable this facility?'); ?>" type="button">
    ...
    <div id="cuModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.carlocation.countr.add')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\hotellatest1\hotellatest\laravel\files\core\resources\views/admin/carcitycountry.blade.php ENDPATH**/ ?>