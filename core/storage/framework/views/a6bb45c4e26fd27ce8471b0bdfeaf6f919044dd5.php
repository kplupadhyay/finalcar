                        ...
                        <table class="table--light style--two table">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $owners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e(__($owner->hotelSetting->name)); ?></td>
                                        <td><?php echo e($owner->fullname); ?></td>
                                        <td><?php echo e(__(@$owner->hotelSetting->location->name)); ?></td>
                                        <td><?php echo e(__(@$owner->hotelSetting->city->name)); ?></td>
                                        <td><?php echo e(__(@$owner->hotelSetting->country->name)); ?></td>
                                        <td>
                                            <?php echo e(showDateTime($owner->created_at, 'd M,Y h:iA')); ?>

                                        </td>
                                        <td>
                                            <div class="button--group">
                                                <a class="btn btn-sm btn-outline--primary" href="<?php echo e(route('admin.vendor.request.detail', $owner->id)); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\hotellatest1\hotellatest\laravel\files\core\resources\views/admin/vendor_request/list.blade.php ENDPATH**/ ?>