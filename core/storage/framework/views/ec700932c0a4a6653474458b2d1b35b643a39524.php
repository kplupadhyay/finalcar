    ...
    <div class="row ">
      <div class="col-md-12 mb-30">
            <div class="card bl--5-primary">
                <div class="card-body">
                    <p class="fw-bold text--primary"><?php echo app('translator')->get('From this page, you can add/update CSS for the user interface. Changing content on this page required programming knowledge.'); ?></p>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.1\htdocs\hotellatest1\hotellatest\laravel\files\core\resources\views/admin/setting/custom_css.blade.php ENDPATH**/ ?>