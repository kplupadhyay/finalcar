<?php $__env->startSection('panel'); ?>
    <div class="row justify-content-center">
        <?php if(request()->routeIs('admin.withdraw.log') || request()->routeIs('admin.withdraw.method') || request()->routeIs('admin.owners.withdrawals') || request()->routeIs('admin.owners.withdrawals.method')): ?>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdraw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span><?php echo e(@$withdraw->owner->fullname); ?></span>
                                            <br>
                                            <span> <a href="<?php echo e(appendQuery('search', @$withdraw->owner->email)); ?>"><?php echo e(@$withdraw->owner->email); ?></a> </span>
                                        </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hotel\hotellatest1\hotellatest\laravel\files\core\resources\views/admin/withdraw/withdrawals.blade.php ENDPATH**/ ?>