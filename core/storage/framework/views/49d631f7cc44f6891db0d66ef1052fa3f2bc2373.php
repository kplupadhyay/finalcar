                ...
                <div class="col-lg-7">
                    <div class="owner-form">
                        <div class="card custom--card custom--card--lg">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('vendor.request.send')); ?>" method="POST" class="verify-gcaptcha">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <div class="col-sm-6">
    ...
    <script>
        ...
        (function($) {
            ...
            $('.checkUser').on('focusout', function(e) {
                var url = "<?php echo e(route('vendor.check.user')); ?>";
                var value = $(this).val();
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.1\htdocs\hotellatest1\hotellatest\laravel\files\core\resources\views/templates/basic/owner_request.blade.php ENDPATH**/ ?>