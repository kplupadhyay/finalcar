    ...
    <div class="row gy-4">
        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-sm-6 col-lg-4">
                    <a class="btn btn--primary btn--shadow w-100 btn-lg" href="{{ route('admin.carusers.notification.log', $user->id) }}">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.carusers.update', [$user->id]) }}" enctype="multipart/form-data" method="POST">
                        @csrf
