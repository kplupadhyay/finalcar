        ...
        <div class="col-lg-7">
            <div class="row gy-4">
                ...
                <div class="col-12 text-end">
                    <button class="btn btn--danger confirmationBtn" data-action="{{ route('admin.carvendor.request.reject', $owner->id) }}" data-question="@lang('Are you sure you want to reject this request?')" type="button"><i class="las la-trash-alt"></i>@lang('Reject')</button>

                    <button class="btn btn--primary confirmationBtn" data-action="{{ route('admin.carvendor.request.approve', $owner->id) }}" data-question="@lang('Are you sure you want to approve this request?')" type="button"><i class="las la-check"></i>@lang('Approve')</button>
                </div>
            </div>
        </div>
    </div>
