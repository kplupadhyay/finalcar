                                        ...
                                        @foreach ($item as $imgKey => $image)
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <x-image-uploader :imagePath="getImage('assets/images/frontend/' . $key . '/' . @$content->data_values->$imgKey, @$section->content->images->$imgKey->size)" :required="false" :size="$section->content->images->$imgKey->size" class="w-100" id="image-upload-input{{ $loop->index }}" name="image_input[{{ @$imgKey }}]" />
                                                </div>
                                            </div>
                                        @endforeach
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="input-group">
                                                            <input autocomplete="off" class="form-control iconPicker icon" name="{{ $k }}" required type="text" value="{{ @$content->data_values->$k }}">
                                    ...
                                    @elseif($k == 'images')
                                        @foreach ($type as $imgKey => $image)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-image-uploader :imagePath="getImage('assets/images/frontend/' . $key . '/' . @$content->data_values->$imgKey, @$section->element->images->$imgKey->size)" :size="$section->element->images->$imgKey->size" class="w-100" id="addImage{{ $loop->index }}" name="image_input[{{ @$imgKey }}]" />
                                            </div>
                                        @endforeach
                                    ...
                                    @elseif($k == 'images')
                                        @foreach ($type as $imgKey => $image)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-image-uploader :imagePath="getImage('', $section->element->images->$imgKey->size)" :required="false" :size="$section->element->images->$imgKey->size" class="w-100" id="updateImage{{ $loop->index }}" name="image_input[{{ @$imgKey }}]" />
