                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <x-image-uploader name="image_input" class="w-100" :imagePath="getImage(getFilePath('seo') . '/' . @$seo->data_values->image, getFileSize('seo'))" :size="getFileSize('seo')" :required="false" />
                                </div>
                            </div>
