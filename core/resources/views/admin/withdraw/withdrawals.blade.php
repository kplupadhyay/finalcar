...
@section('panel')
    <div class="row justify-content-center">
        @if (request()->routeIs('admin.withdraw.log') || request()->routeIs('admin.withdraw.method') || request()->routeIs('admin.owners.withdrawals') || request()->routeIs('admin.owners.withdrawals.method'))
                            ...
                            <tbody>
                                @forelse($withdrawals as $withdraw)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span>{{ @$withdraw->owner->fullname }}</span>
                                            <br>
                                            <span> <a href="{{ appendQuery('search', @$withdraw->owner->email) }}">{{ @$withdraw->owner->email }}</a> </span>
                                        </td>
