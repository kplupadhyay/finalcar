                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span>@lang('Date')</span>
                            <span>{{ showDateTime($withdrawal->created_at) }}</span>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="text-end">
                                <a href="{{ route('admin.owners.detail', $withdrawal->owner_id) }}">{{ @$withdrawal->owner->fullname }}</a>
                                <br>
                                <a href="mailTo:{{ @$withdrawal->owner->email }}">{{ @$withdrawal->owner->email }}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span>{{ showAmount($withdrawal->amount) }} {{ __($general->cur_text) }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span>@lang('Charge')</span>
                            <span>{{ showAmount($withdrawal->charge) }} {{ __($general->cur_text) }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span>@lang('After Charge')</span>
                            <span>{{ showAmount($withdrawal->after_charge) }} {{ __($general->cur_text) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span>@lang('Rate')</span>
                            <span>1 {{ __($general->cur_text) }}
                        ...
                        @if ($withdrawal->admin_feedback)
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <span>@lang('Admin Response')</span>
                                <p>{{ __($withdrawal->admin_feedback) }}</p>
                            </li>
                        @endif
                    </ul>
                </div>
