                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="being_sent_to" required>
                                            @foreach ($notifyToOwner as $key => $toOwner)
                                                <option value="{{ $key }}">{{ __($toOwner) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 start-from-col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="start_form" placeholder="@lang('Start form vendor')" required type="number" />
                                        </div>
                                    </div>
                                    <div class="col-md-4 per-batch-col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="batch" placeholder="@lang('How many vendor')" required type="number" />
                                    ...
                                    <div class="col-md-4 cooling-period-col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="cooling_time" placeholder="@lang('Waiting time')" required type="number" />
                                                <span class="input-group-text">
                                                    @lang('Seconds')
                                                </span>
                                            </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        <p class="sentStatistics text-center mb-2">@lang('Email sent') <span class="startFrom">0</span> @lang('to') <span class="sent">-</span> @lang('VENDORS')
                        </p>
    ...
    <script>
        (function($) {
            ...
            $('.notify-form').on('submit', function(e) {
                ...
                owner = $(".input-append").find(`#owner_list`).val();

                number_of_top_deposited_owner = $(".input-append").find('input[name=number_of_top_deposited_owner]').val();
                number_of_days = $(".input-append").find('input[name=number_of_days]').val();
                _token = $(this).find('[name=_token]').val();

                if ({{ $owners }} <= 0) {
                    notify('error', 'Vendors not found');
                    return false;
                }
                if (!coolingTime) {
            ...
            function postMail() {
                ...
                $.post("{{ route('admin.owners.notification.all.send') }}", {
                    "subject": subject,
                    "_token": _token,
                    "start": start,
                    "batch": perBatch,
                    ...
                    'owner': owner,
                    'number_of_top_deposited_owner': number_of_top_deposited_owner,
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDOWNERS') {
                    ...
                    <div class="form-group" id="owner_list_wrapper">
                        <label class="required">@lang('Select Owner')</label>
                ...
                if (methodName == 'TOPDEPOSITEDOWNERS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required">@lang('Number Of Top Deposited Vendor')</label>
