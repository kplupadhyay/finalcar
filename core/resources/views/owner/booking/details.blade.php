...
@section('panel')
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex flex-column gap-3">
                        ...
                        @php
                            $address = $booking->user_id ? $booking->user->address->address : @$booking->guest->address;
                        @endphp
            ...
            <div class="accordion d-flex flex-column gap-4">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="bookedRoomsHeading">
                        <button aria-controls="bookedRooms" aria-expanded="true" class="accordion-button" data-bs-target="#bookedRooms" data-bs-toggle="collapse" type="button">@lang('Booked Rooms')</button>
                    </h2>
                                ...
                                <table class="custom--table head--base table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold">
                                                {{ showAmount($receivedPayments->sum('amount')) }} {{ __($general->cur_text) }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <table class="custom--table head--base table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bold">
                                            {{ showAmount($returnedPayments->sum('amount')) . __($general->cur_text) }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                @if ($booking->total_discount > 0)
                                    <li class="d-flex justify-content-between list-group-item align-items-start">
                                        ...
                                        <span> -{{ $general->cur_sym . showAmount($booking->total_discount) }}</span>
                                    </li>

                                    <li class="d-flex justify-content-between list-group-item align-items-start fw-bold">
                                        <span>@lang('Subtotal')</span>
                                        <span> ={{ $general->cur_sym . showAmount($totalFare - $booking->total_discount) }}</span>
                                    </li>
                                @endif
                                <li class="d-flex justify-content-between list-group-item align-items-start">
                                    <span>{{ __(hotelSetting('tax_name')) }} @lang('Charge') <small>({{ getAmount($booking->taxPercentage()) }}%)</small></span>
    ...
    @can(['owner.booking.details', 'owner.booking.booked.rooms', 'owner.booking.service.details', 'owner.booking.payment', 'owner.booking.key.handover', 'owner.booking.merge', 'owner.booking.cancel', 'owner.booking.extra.charge', 'owner.booking.checkout', 'owner.booking.invoice', 'owner.booking.all'])
