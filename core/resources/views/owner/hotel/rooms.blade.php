                        ...
                        <table class="table--light style--two table">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Type')</th>
                                    <th>@lang('Status')</th>
                                    @can(['owner.hotel.room.status', 'owner.hotel.room.add'])
                                        <th>@lang('Action')</th>
                                    @endcan
                                </tr>
                            </thead>
                                        ...
                                        @can(['owner.hotel.room.status', 'owner.hotel.room.add'])
                                            <td>
                                                ...
                                                @if ($room->status == Status::ENABLE)
                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn" data-action="{{ route('owner.hotel.room.status', $room->id) }}" data-question="@lang('Are your to enable this room?')" type="button">
                                                        <i class="la la-eye-slash"></i>@lang('Disable')
                                                    </button>
                                                @else
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn" data-action="{{ route('owner.hotel.room.status', $room->id) }}" data-question="@lang('Are your to disable this room?')" type="button">
