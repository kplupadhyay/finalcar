            ...
            <div class="login-area">
                ...
                <form action="{{ route('owner.password.verify.code') }}" method="POST" class="login-form w-100">
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <a href="{{ route('owner.password.reset') }}" class="forget-text">@lang('Try to send again')</a>
                    </div>
                    <button type="submit" class="btn cmn-btn w-100 mt-4">@lang('Submit')</button>
                </form>
                <a href="{{ route('owner.login') }}" class="text-white mt-4"><i class="las la-sign-in-alt" aria-hidden="true"></i>@lang('Back to Login')</a>
            </div>
        </div>
    </div>
